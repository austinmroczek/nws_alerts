...
The main sensor's state is the **count of currently active alerts**. It is named after the Friendly Name you entered during setup (e.g. if you named it "Home", the sensor is `sensor.home_alert_count`).
...
Each sensor always exposes two attributes (empty lists when no alerts are active):
...
| **Fog**            | Dense Fog Advisory, Freezing Fog Advisory, Ice Fog Advisory                                                                                                                      | —                                                                                  | —                                                                                                                                                                              |
...
| **Heat**           | Heat Advisory                                                                                                                                                                    | Excessive Heat Watch, Extreme Heat Watch                                            | Excessive Heat Warning, Extreme Heat Warning                                                                                                                                    |
